...
if __name__ == '__main__':
    ...
    dset_train = TrajectoryDataset(data_set + 'tiny_train/', obs_len=obs_seq_len, pred_len=pred_seq_len, skip=1,
                                   norm_lap_matr=True)
    ...
    dset_val = TrajectoryDataset(data_set + 'tiny_val/', obs_len=obs_seq_len, pred_len=pred_seq_len, skip=1,
                                 norm_lap_matr=True)
